      ...
      <section className="checkout__section mt-12">
        <div className="container">
          <div className="checkout__section-title">
             <p className="text-[#ffffff99] flex gap-x-2 font-bold">کد تخفیف دارید؟<Link to={'/cart'} className="text-purple font-bold">برای نوشتن کد اینجا کلیک کنید</Link></p>
          </div>
          
          <div className="checkout__section-content mt-12 flex flex-col lg:flex-row gap-x-8">
            <form action="#" className="checkout__section-right-content w-full  lg:w-[60%] flex flex-col">
                <legend className="checkout__right-conent__title text-[26px] font-bold">جزئیات صورتحساب</legend>
                <div className="checkout-name__inputs-wrapper flex flex-col xs:flex-row mt-12">
                  <FormInput title={'نام'} type={'text'} required={true} style={'w-full bg-secondary'} 
                  labelMargin={'-mt-6'} inputStyle={'bg-secondary'}/>
                  <FormInput title={'نام خانوادگی'} type={'text'} required={true} style={'w-full bg-secondary'} 
                  labelMargin={'xs:-mt-6 xs:translate-x-[-65px] whitespace-nowrap'} inputStyle={'bg-secondary'}/>
                </div>
                <FormInput title={'شرکت(اختیاری)'} type={'text'} labelMargin={'-mb-2'} style={'w-full bg-secondary'} inputStyle={'bg-secondary'}/>
                <FormInput title={'کشور / منطقه'} placeholder={'ایران'} required={true} type={'text'} labelMargin={'-mb-2'} style={'w-full bg-secondary'} inputStyle={'bg-secondary'}/>
                <FormInput title={'استان'} placeholder={'تهران'} required={true} type={'text'} labelMargin={'-mb-2'} style={'w-full bg-secondary'} inputStyle={'bg-secondary'}/>
                ...
                <FormInput title={'ایمیل'} required={true} type={'email'} style={'w-full bg-secondary'} inputStyle={'bg-secondary'}/>
                <div className="additional-information__wrapper">
                  <h4 className="additional-information__title mb-6 text-[26px] font-bold">
                    توضیحات تکمیلی
                  </h4>
                  <span className="additional-information__subtitle text-[#ffffff99]">توضیحات سفارش (اختیاری)</span>
                  <textarea className="w-full rounded-3xl outline-none py-2 px-4 text-[14px] mt-4 border border-[#7773] focus:border-[#7777774d] bg-secondary min-h-[190px]" placeholder="یادداشت ها درباره سفارش شما،برای مثال نکات مهم درباره نحوه تحویل سفارش"></textarea>
                </div>
            </form>
            <div className="checkout__section-left-content w-full mt-12 lg:mt-0  lg:w-[40%] xs:max-h-[600px] border-2 border-purple rounded-lg flex flex-col gap-y-8 p-8">
                ...
                <div className="product-checkout__wrapper flex flex-wrap sm1:flex-nowrap justify-between border-b border-b-[#7773] pb-4 -mt-4">
                   <span className="product-title text-[#777]">مورتال کمبت 11 آلتیمیت  × 1</span>
                   <span className="product-price text-purple">{digitsEnToFa(150000)}تومان</span>
                </div>
                <div className="checkout-left-content__subtitle-wrapper flex flex-wrap sm1:flex-nowrap justify-between  border-b border-b-[#7773] pb-4 -mt-4">
                  <span className="font-bold">جمع جز</span>
                  <span className="font-bold text-purple">{digitsEnToFa(150000)}تومان</span>
                </div>
                <div className="checkout-left-content__subtitle-wrapper flex flex-wrap sm1:flex-nowrap justify-between  border-b border-b-[#7773] pb-4 -mt-4">
                ...
                <button type="button" className="aplly-orders__btn shadow-box hover:shadow-boxHover text-[14px] bg-purple px-4 py-3 rounded-3xl">ثبت سفارش</button>
            </div>
          </div>
        </div>
      </section>
