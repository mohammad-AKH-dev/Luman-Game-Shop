...
export default function ShopGameBox({discount,price,percent}) {
  return (
    <Link to={'/'}>
     <div className='Shop-Game-box relative mt-8 max-w-[400px]'>
       <img src="images/games/red dead2.webp" className="max-w-full rounded-md" />
       {
        percent && <div className="discount-badge absolute text-[13px] bg-purple px-4 rounded-sm py-1 top-4 right-4">{digitsEnToFa(percent)}%-</div>
       }
